export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Icon button */}
      <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-green-300/60 hover:shadow-2xl hover:scale-110 transition-all duration-300">
        {/* Pulse ring */}
